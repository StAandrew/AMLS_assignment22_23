...
from helper_utils import (
    helper_plot_learning,
    helper_plot_learning,
    helper_plot_grid_c,
    helper_plot_grid_gamma,
    helper_plot_confusion_matrix,
)
...
class A2:
    ...
    def output_info(self):
        ...
        for mean_score, params in zip(
            self.results["mean_test_score"], self.results["params"]
        ):
    ...
    def plot_learning(self, figure_save_path, learning_curve_path):
        try:
            ...
            self.logger.info(
                "Learning curve data file not found, creating a new one..."
            )
        ...
        self.logger.info("Learning curve plot created.")
